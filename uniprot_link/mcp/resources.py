...
UNIPROT_SERVER_INSTRUCTIONS = (
    ...
    "- Discovery: find_proteins(gene=, organism_taxon=, reviewed=, keyword=, "
    ...
    "accepted as aliases; name_contains matches per word (any order). Resolve "
    "organism names to a taxon id with get_taxon. For several genes at once use "
    "find_proteins_batch(genes=[...]) -- it resolves them concurrently in one "
    "call and reports unresolved_genes.\n"
